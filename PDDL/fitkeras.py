...
class TwoImagesGenerator(keras.utils.Sequence):
...
model.fit(
            trainGenerator, #TwoImagesGenerator(trainGenerator, trainGenerator2),
            epochs=30,
            validation_data=validationGenerator, #validation_data=TwoImagesGenerator(validationGenerator, validationGenerator2),
            # steps_per_epoch=nbSample // batchSize,
